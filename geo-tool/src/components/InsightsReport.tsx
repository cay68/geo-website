...
const InsightsReport = ({ startLoading, stopLoading, onAddToHistory, prefilledContent, prefilledPrompts, onClearData }: InsightsReportProps) => {
  ...
  const [isVisibilityTrendExpanded, setIsVisibilityTrendExpanded] = useState(false)
    ...
    <div className="tool-layout">
      ...
      {dashboardData && (
        <div className="dashboard-container" ref={resultsRef} style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              {!isVisibilityTrendExpanded && (
                <div style={{
                  ...
                  <button
                    onClick={() => {
                      setIsVisibilityTrendExpanded(true)
                      navigate('/tool?tool=insights-report&state=output&section=visibility-trend', { replace: true })
                    }}
                    style={{
                      padding: '14px 32px',
                      background: '#1a1a1a',
                  ...
                  <div style={{
                    ...
                    <button
                      onClick={() => {
                        ...
                        navigate('/tool?tool=insights-report&state=output&section=leaderboard', { replace: true })
                      }}
                      style={{
                        padding: '12px 24px',
                        background: '#1a1a1a',
                  ...
                  <div style={{
                    ...
                    <button
                      onClick={() => {
                        ...
                        navigate('/tool?tool=insights-report&state=output&section=platform', { replace: true })
                      }}
                      style={{
                        padding: '12px 24px',
                        background: '#1a1a1a',
          ...
          {/* Row 4: Top Performing Prompts Bar Chart */}
          <div style={{
            borderRadius: '12px',
            padding: '24px',
            position: 'relative'
                ...
                <div style={{
                  ...
                  <button
                    onClick={() => {
                      ...
                      navigate('/tool?tool=insights-report&state=output&section=prompts', { replace: true })
                    }}
                    style={{
                      padding: '14px 32px',
                      background: '#1a1a1a',
