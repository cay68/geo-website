                  ...
                  {dashboardData.brandRankings.map((brand: BrandRanking, index: number) => (
                    <div
                      ...
                      style={{
                        ...
                        transition: 'all 0.2s ease',
                        backgroundColor: brand.name === "Mandy's Home Store" ? '#f0fdf4' : 'transparent',
                        borderRadius: brand.name === "Mandy's Home Store" ? '8px' : '0',
                        paddingLeft: brand.name === "Mandy's Home Store" ? '12px' : '0',
                        paddingRight: brand.name === "Mandy's Home Store" ? '12px' : '0'
                      }}
                    >
                      <div style={{
                        fontSize: '1.1rem',
